...
class Pivot extends \koolreport\core\Process
{
    ...
    public function onInit()
    {
        ...
        $isUpdate = false;
        // echo "_POST 1 = "; print_r($_POST); echo '<br>';
        // echo "input string = "; echo file_get_contents("php://input"); echo '<br>';
        ...
        // if (isset($input['koolPivotUpdate'])) {
            // echo "koolPivotConfig = "; var_dump($_POST['koolPivotConfig']); echo '<br>';
            $config = json_decode($_POST['koolPivotConfig'], true);
            // echo "config = "; print_r($config); echo '<br>';
    ...
    public function onInput($row)
    {
        ...
        // echo "dataNodes = "; print_r($dataNodes); echo '<br>';
