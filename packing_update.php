<?php 
    ...
    $getCategory ="SELECT * FROM packing WHERE PackingId = '$categoryId' AND AppCode = '$appCode' AND Deleted = 'No'";
    $conCategory = mysqli_query($conn,$getCategory);
    $rowCategory = mysqli_fetch_assoc($conCategory);
    $categoryId = $rowCategory['PackingId'];
    $productCategoryName = $rowCategory['PackingName'];
    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12">
                <h3 class="content-header-title">EDIT Packing</h3>
            </div>
        </div>
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $sqlProductUpdatec = "UPDATE packing SET PackingName = '$productCategoryName', UpdatedDateTime = Now() WHERE PackingId = '$categoryId' AND AppCode = '$appCode' AND Deleted = 'No'";
        ...
        ?>
            <script type="text/javascript">
                toastr.success('Packing Updated Successfully', '', {positionClass: 'toast-top-center', containerId: 'toast-top-center'});
                setTimeout(function()
                {
