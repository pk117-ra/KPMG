<?php 
    ...
    $getCategory ="SELECT * FROM category WHERE CategoryId = '$categoryId' AND AppCode = '$appCode' AND Deleted = 'No'";
    $conCategory = mysqli_query($conn,$getCategory);
    $rowCategory = mysqli_fetch_assoc($conCategory);
    $categoryId = $rowCategory['CategoryId'];
    $productCategoryName = $rowCategory['ProductCategoryName'];
...
<?php
    if(isset($_POST['submit']))
    {
        ...
        $sqlProductUpdatec = "UPDATE category SET ProductCategoryName = '$productCategoryName', UpdatedDateTime = Now() WHERE CategoryId = '$categoryId' AND AppCode = '$appCode' AND Deleted = 'No'";
        ...
        ?>
            <script type="text/javascript">
                toastr.success('Group Updated Successfully', '', {positionClass: 'toast-top-center', containerId: 'toast-top-center'});
                setTimeout(function()
                {
