    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12">
                <h3 class="content-header-title">Sales Contract</h3>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $("#productCategoryDetails").DataTable({
        ...
        "ajax":"sales_contract_ssp.php?appcode="+appcode+"&id=1",
    });
    $(".productdetails").click(function()
    {
        var id = $(this).attr("value");
            ...
            "ajax":"sales_contract_ssp.php?appcode="+appcode+"&id="+id,
        });
    });
    // alert("appCode");
    $(document).on("click",".deleteid",function()
    {
        ...
        }, function(isConfirm) 
        {
            if(isConfirm) 
            {
               $.post("delete_process_new.php",{data1:tname,data2:appcode,data3:id,data4:colname},function(data)
               {
                    if(data == 'yes')
                    {
    ...
    var urlpathname = 'sales_contract_add.php';
</script>
