  	...
  	<div class="content-wrapper">
        <div class="content-header row">
           	<div class="content-header-left col-md-6 col-xs-12">
            	<h3 class="content-header-title">Type</h3>
          	</div>
        </div>
...
<script type="text/javascript">
    ...
    $("#category").DataTable({
        ...
        "responsive":true,
        "deferRender":true,
        "ajax":"product_type_ssp.php?appcode="+appcode+"&id=1",
    });
    $(".categoryDetails").click(function()
    {
        ...
        $("#category").DataTable({
            ...
            "responsive":true,
            "deferRender":true,
            "ajax":"product_type_ssp.php?appcode="+appcode+"&id="+id,
        });
    });
    // alert("appCode");
    ...
    var urlpathname = 'product_type_add.php';
</script>
