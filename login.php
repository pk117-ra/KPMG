...
// setcookie('usercheck', '', time() + (86400 * 1),true);
$date= date('Y');
?>
<!DOCTYPE html>
<html lang="en">
                                      ...
                                      <div class="card-block">
                                        <form method="post" id="loginformsubmit" action="login_check_username.php" autocomplete="off" style="text-align: center !important;">
                                          <div class="form-group">
                                              <input style="position: relative;top: 40px;border-bottom: 1px solid  #000" type="text" class="text-line" id="userName" name="userName" placeholder="Enter User Name">
